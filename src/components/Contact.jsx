...
function Contact() {
  return (
    <div className="container mb-6 mt-6  " id="contact">
      ...
      {/* </div> */}
      <div className="text-xl font-medium mb-3 sm:px-36">
        Got a question, proposal, project, or want to work together on
        something?
      </div>
      <div className="sm:px-36">
        <button className=" text-2xl font-medium cursor-pointer bg-[#E7D4B5] hover:shadow-md hover:bg-[#D1BB9E] rounded-lg px-6 py-3">
